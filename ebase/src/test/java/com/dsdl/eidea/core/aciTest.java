...
//        runtimeService=processEngine.getRuntimeService();
 ...
 @Transactional
    public void createTable() {
        ...
        processEngineConfiguration.setJdbcUrl("jdbc:mysql://192.168.0.204:3306/e_idea");
...
@Transactional
   ...
   /*  repositoryService = processEngine.getRepositoryService();
    ...
    //部署流程
   repositoryService.createDeployment().addClasspathResource("diagrams/activitiOne.bpmn").name("请假流程").category("请假").deploy();
