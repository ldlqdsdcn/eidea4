...
<div class="container-fluid">
    ...
    <uib-tabset class="nav nav-tab vertical-tab" vertical="true" >
    ...
    <div class="tab-content vertical-tab-content" ng-controller="editCtrl" ng-show="show">
                ...
                <div class="span12">
                    ...
                    <div class="form-group">
                        <p class="text-right">
                            ...
                            <a href="#/list？id=null" class="btn btn-default btn-sm"><%--返回--%><eidea:label key="common.button.back"/></a>
                        </p>
                    </div>
                    <div class="form-group">
    ...
    <div class="tab-content vertical-tab-content" ng-controller="listCtrl" ng-show="!show">
        <div class="row-fluid">
            <div class="span12">
