...
<div  class="container-fluid" ng-controller="listCtrl">
    <div class="page-header" >
        <ol class="breadcrumb">
            <li><a href="javascript:;"><i class="icon icon-tasks"></i> <%--访问目录--%><eidea:label key="directory.access.directory"/></a></li>
        </ol>
        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr ng-repeat="model in modelList track by $index" ng-class-even="success">
                    ...
                    <td>
                        <a class="btn btn-primary btn-xs" href="#/edit?id={{model.id}}" btn-xs><eidea:label key="common.button.edit"/><%--编辑--%></a>
                    </td>
                </tr>
                </tbody>
            </table>
