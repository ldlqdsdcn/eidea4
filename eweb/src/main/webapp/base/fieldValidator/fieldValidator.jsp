...
<html>
<head>
    <title><%--字段验证--%><eidea:label key="fieldValidator.title"/></title>
...
<script type="text/javascript">
    var app = angular.module('myApp', ['ngRoute', 'ui.bootstrap', 'jcs-autoValidate'])
            .config(['$routeProvider', function ($routeProvider) {
                $routeProvider
                        .when('/list', {templateUrl: '<c:url value="/base/fieldValidator/list.tpl.jsp"/>'})
                        .when('/edit', {templateUrl: '<c:url value="/base/fieldValidator/edit.tpl.jsp"/>'})
...
$http.post("<c:url value="/base/fieldValidator/list"/>", $scope.queryParams)
...
$scope.pageChanged();
    ...
    app.controller('editCtrl', function ($scope, $http, $routeParams) {
        ...
        if ($routeParams.id != null) {
            url = "<c:url value="/base/fieldValidator/get"/>" + "?id=" + $routeParams.id;
        }
        $http.get(url)
                .success(function (response) {
                    if (response.success) {
