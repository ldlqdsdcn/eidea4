...
<div  class="container-fluid" ng-controller="listCtrl">
    <div class="page-header" >
        <ol class="breadcrumb">
            <li><a href="javascript:;"><i class="icon icon-tasks"></i><eidea:label key="settings.title"/></a></li>
        </ol>
        ...
        <div class="span12">
            <table  class="table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th><%--key--%><eidea:label key="base.settings.label.key"/></th>
                    <th><%--键值--%><eidea:label key="base.settings.label.value"/></th>
                    <th><%--description--%><eidea:label key="base.settings.label.description"/></th>
