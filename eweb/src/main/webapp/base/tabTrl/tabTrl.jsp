...
<html>
<head>
    <title><%--Tab页翻译--%><eidea:label key="tabTrl.title"/></title>
...
<script type="text/javascript">
    var app = angular.module('myApp', ['ngRoute', 'ui.bootstrap', 'jcs-autoValidate'])
            .config(['$routeProvider', function ($routeProvider) {
                $routeProvider
                        .when('/list', {templateUrl: '<c:url value="/base/tabTrl/list.tpl.jsp"/>'})
                        .when('/edit', {templateUrl: '<c:url value="/base/tabTrl/edit.tpl.jsp"/>'})
...
$http.post("<c:url value="/base/tabTrl/list"/>", $scope.queryParams)
...
$scope.pageChanged();
    ...
    app.controller('editCtrl', function ($scope, $http, $routeParams) {
        ...
        if ($routeParams.id != null) {
            url = "<c:url value="/base/tabTrl/get"/>" + "?id=" + $routeParams.id;
        }
        $http.get(url)
                .success(function (response) {
                    if (response.success) {
