...
<div class="container-fluid" ng-controller="editCtrl">
    ...
    <uib-tabset class="nav nav-tab vertical-tab" vertical="true" active="active">
        ...
        <uib-tab index="4" heading="<eidea:label key="field.title"/> "></uib-tab>
        <uib-tab index="5" heading="<eidea:label key="fieldTrl.title"/> "></uib-tab>
    </uib-tabset>
    </div>
    <div ui-view class="tab-content vertical-tab-content" ng-show="tabListshow||windowTrlListShow||tabTrlListShow"></div>
