...
<div class="container-fluid" ng-controller="listCtrl">
    <div class="page-header">
        <ol class="breadcrumb">
            <li><a href="javascript:;"><i class="icon icon-tasks"></i><%--标签--%><eidea:label key="customerext.column.proplabel"/></a></li>
        </ol>
        ...
        <div class="span12">
            <table class="table table-hover table-striped table-condensed">
                ...
                <tr>
                    ...
                    <th align="center"><%--键值--%><eidea:label key="label.keyvalue"/></th>
