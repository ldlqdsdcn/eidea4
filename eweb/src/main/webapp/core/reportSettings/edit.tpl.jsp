        ...
        <div class="span12">
            ...
            <form role="form" name="editForm" novalidate  ng-submit="save()">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="key" ng-model="reportBo.key" placeholder="<eidea:message key="common.please.input"><eidea:param value="label.keyvalue" type="label"/></eidea:message>" required ng-minlength="2" ng-maxlength="45" ng-disabled="!reportBo.created">
                </div>
                <div class="form-group">
