...
<html>
<head>
    <title><%--消息设置--%><eidea:label key="report.title.report.setting"/></title>
...
<script type="text/javascript">
    ...
    app.controller('listCtrl', function ($rootScope,$scope,$http,$window) {
        ...
        $http.post("<c:url value="/core/reportSettings/list"/>",$scope.queryParams)
            ...
            bootbox.confirm({
                ...
                buttons: {
                    ...
                    if (result) {
                        ...
                        $http.post("<c:url value="/core/reportSettings/deletes"/>", param).success(function (data) {
                            if (data.success) {
        ...
        $http.get(url)
                .success(function (response) {
                    if (response.success) {
                        ...
                        $scope.tableId=$scope.reportBo.key;
