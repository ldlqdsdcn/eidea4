...
<html>
<head>
    <title><%--用户会话记录--%><eidea:label key="userSession2.title"/></title>
...
$http.post("<c:url value="/sys/userSession2/list"/>", $scope.queryParams)
...
$http.post("<c:url value="/sys/userSession2/deletes"/>", param).success(function (data) {
if (data.success) {
