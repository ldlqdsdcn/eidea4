                ...
                <table  class="table table-hover table-striped table-condensed">
                    ...
                    <tr ng-repeat="model in modelList track by $index" ng-class-even="success">
                        ...
                        <td ng-show="model.assignee!=null&&model.assignee!=''">
                            ...
                            <button class="btn btn-primary btn-sm" ng-click="approve(model.taskId)"><%--同意--%><eidea:label key="common.button.agree"/></button>
                            <button class="btn btn-primary btn-sm" ng-click="reject(model.taskId)"><%--拒绝--%><eidea:label key="common.button.refuse"/></button>
                        </td>
                        <td ng-show="model.assignee==null||model.assignee==''">
                            <button class="btn btn-primary btn-sm" ng-click="claim(model.taskId)"><%--签收--%><eidea:label key="common.button.sign"/></button>
                        </td>
                    </tr>
                    </tbody>
                </table>
